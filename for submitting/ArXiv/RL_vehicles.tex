...
\begin{document}
	...
	\begin{frontmatter}
		...
		\author[firstAddress]{Fabian Hart\corref{corrAuthor}}
		\cortext[corrAuthor]{Corresponding author}
		\ead{fabian.hart@tu-dresden.de}
		\author[firstAddress]{Ostap Okhrin}
		\author[firstAddress]{Martin Treiber}
		
		
		\address[firstAddress]{Technische Universität Dresden\\
			01062 Dresden\\
			Germany}
	...
	\begin{figure}
		\centering
		\includegraphics[width=12cm]{MRL_small.pdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=12cm]{TrainingReward}
	...
	\begin{figure}
		\centering
		\includegraphics[width=12cm]{RewardFunc1.pdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{AR1process}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{manipulatedLeader.eps}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{VarAccComp}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{AR1Kolonne}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{PunzoKolonne}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{differentT}
	...
	\begin{figure}
		...
		\centering
		\includegraphics[width=0.95\textwidth]{IDMvsRL_dist}
	...
	\begin{figure}	
		\centering
		\includegraphics[width=0.95\textwidth]{TTC}
	...
	\begin{figure}	
		\centering
		\includegraphics[width=0.95\textwidth]{TTC_CaseStudy}
